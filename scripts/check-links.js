...
'use strict';
/**
 * check-links.js — reference link-health checker for data/forum.json.
 *
 ...
 * health" issue. It never edits data/forum.json.
 *
...
function toMarkdown(report) {
  ...
  lines.push('_Generated by `scripts/check-links.js`. This report never edits `data/forum.json`; it flags URLs for manual review and for `scripts/archive-refs.js`._');
  // <<< ADOPT
  return lines.join('\n') + '\n';
}
